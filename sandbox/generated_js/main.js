...
React.createElement(PartialsHello, React.__spread({},  this.props)), !!this.props.people ? (  v = this.props.people,  toString.call(v) === "[object Object]" ? (v = [v]) : (null),  toString.call(v) === "[object Array]" ? (    v.map(function(el, ndx) {      return (    React.createElement("div", {key: ndx}, 
      React.createElement("p", {id: this.props.element_id, className: "" + (!!true ? " something" : "") + (!!this.props.b_show_class ? " something-else" : "")}, !!(!!el && !!el.name) ? (el.name) : (!!(!!this.state && !!this.state.name) ? (this.state.name) : (!!(!!this.props && !!this.props.name) ? (this.props.name) : (null))))
    )
);    }.bind(this))  ) : (    React.createElement("div", {key: ndx}, 
      React.createElement("p", {id: this.props.element_id, className: "" + (!!true ? " something" : "") + (!!this.props.b_show_class ? " something-else" : "")}, !!(!!this.state && !!this.state.name) ? (this.state.name) : (!!(!!this.props && !!this.props.name) ? (this.props.name) : (null)))
    )
